...
cor2 = "#004338" # Verde Escuro / Dark Green
...
l_red = Label(frame_direita, text='Red', width=7, bg=cor1, fg='red', anchor='center', font = ("Times New Roman", 12, "bold"))
...
l_green = Label(frame_direita, text='Green', width=7, bg=cor1, fg='green', anchor='nw',font = ("Times New Roman", 12, "bold"))
...
l_blue = Label(frame_direita, text='Blue', width=7, bg=cor1, fg='blue', anchor='nw', font = ("Times New Roman", 12, "bold"))
